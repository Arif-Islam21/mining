...
import trx from "../assets/images/bep20-usdt.webp";
...
const recharge = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get("api/trxaddress?currency=bnb");
          ...
          >
            ...
            >
              <div className="base-main-btn-content" onClick={handleClick}>
                <span rcwallet-addr="" className="text-black">{t("recharge_completed")}</span>
              </div>
            </a>
          </div>
          <div
