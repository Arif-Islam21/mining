            ...
            <div className="number">
              ...
              <div className="num" style={{color: 'blue'}}>
                {data?.user?.withdraw_balance && data?.settingtrx?.conversion
                  ...
                  : 0}
                <span style={{color: 'blue'}}>TRX</span>
              </div>
            </div>
            {/* number ends */}
            <div className="pay-type align-items-center mb-10px">
              ...
              <div className="flex flex-wrap items-center ">
                <Link
                  to="/withdraw"
                  id="trc20Usdt"
                  className="ml-5px mr-10px inline-block h-30px cursor-pointer border border-$text-gray rd border-solid px-15px leading-30px text-$text-gray border-$primary!!"
                >
                  TRC20-USDT
                </Link>
                <Link
