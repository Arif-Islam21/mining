    ...
    <div id="app" style={containerStyle}>
      ...
      <div>
        <div style={balanceCardStyle}>
          <div style={{ marginBottom: '15px' }}>
            <div style={{ fontSize: '24px', fontWeight: 'bold' }}>
              {(parseFloat(data.withdraw_balance) + parseFloat(data.amount)).toFixed(2)}
            </div>
            <div style={{ opacity: 0.8, fontSize: '14px' }}>{t("total_balance")} (USDT)</div>
          </div>
          <div>
            <div style={{ fontSize: '24px', fontWeight: 'bold' }}>
              {parseFloat(data.amount).toFixed(2)}
            </div>
            <div style={{ opacity: 0.8, fontSize: '14px' }}>{t("recharge_amount")} (USDT)</div>
          </div>
        ...
        <div style={balanceCardStyle}>
          ...
          <div>
            <div style={{ fontSize: '24px', fontWeight: 'bold' }}>
              {data?.user?.teamdeposit || 0.00} USDT
            </div>
        ...
        <div style={menuStyle}>
          <Link to="/account" style={menuItemStyle}>
            <div style={menuTextStyle}>
              <span style={iconStyle}><div className="icon i-material-symbols:account-balance-outline-rounded"></div></span>
              <span>{t("account")}</span>
            </div>
          ...
          <Link to="/recharge-method" style={menuItemStyle}>
            <div style={menuTextStyle}>
              <span style={iconStyle}> <div className="icon i-ic:outline-monetization-on"></div></span>
          ...
          <Link to="/withdraw" style={menuItemStyle}>
            <div style={menuTextStyle}>
              <span style={iconStyle}><div className="icon i-fluent:money-hand-16-regular"></div></span>
          ...
          <Link to="/financial" style={menuItemStyle}>
            <div style={menuTextStyle}>
              <span style={iconStyle}><div className="icon i-ion:ios-trending-up"></div></span>
        ...
        <Link to="/change-password" style={menuItemStyle}>
            <div style={menuTextStyle2}>
              <span style={iconStyle2}><div className="icon i-ph:password-light c-#1b49b9"></div></span>
              <span>{t("change_pass")}</span>
            </div>
            
          </Link>
          <div 
            style={{ ...menuItemStyle, borderBottom: 'none', cursor: 'pointer' }}
            onClick={handleConfirmLogout}
          >
            <div style={menuTextStyle2}>
              <span style={iconStyle3}><div className="icon i-ic:baseline-log-out c-#2c9e90"></div></span>
